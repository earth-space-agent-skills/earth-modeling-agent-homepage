...
const slug = "chuanfei-dong-space-physics-modeling";
...
export const metadata: Metadata = {
  ...
  description:
    "Featured AI blog placeholder for Chuanfei Dong. The full profile is in preparation.",
  alternates: {
        ...
        <div className="ai-article-layout">
          <article className="article-prose reveal">
            <p className="article-lede">
              ...
              will introduce Chuanfei Dong&apos;s work on space physics
              modeling and AI at Boston University. Check back soon.
            </p>
          </article>
